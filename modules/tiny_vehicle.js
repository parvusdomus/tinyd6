...
export default class TINY_VEHICLE_SHEET extends ActorSheet{
    static get defaultOptions() {
      return mergeObject(super.defaultOptions, {
          classes: ["tinyd6", "sheet", "actor"],
          template: "systems/tinyd6/templates/actors/vehicle.html",
          width: 600,
          height: 505,
    ...
    _prepareCharacterItems(sheetData){
      ...
      for (let i of sheetData.items){
        switch (i.type){
          ...
          case 'armor':
          {
            ...
            if (Armors.length <= 0){
              Armors.push(i);
              armorhitpoints=i.system.extralife;
              nImprovements++
            } 
            else{
      ...
      this.actor.update ({'system.resources.improvements.value': nImprovements})
