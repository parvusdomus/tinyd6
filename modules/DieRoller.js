...
export default class DieRoller extends FormApplication {
    ...
    static get defaultOptions() {
        ...
        if (game.user.isGM==true){
            template="systems/tinyd6/templates/dialogs/dice-rollerGM.html"
        }
        else{
            template="systems/tinyd6/templates/dialogs/dice-roller.html"
        }
    ...
    getPos() {
        this.pos = game.user.getFlag("tinyd6", "dieRollerPosition");
    ...
    async _onIntrussion(event)
    {
        ...
        {
            msg_content="<div class=\"tinyd6 test-result\"><h3 class=\"enabled\">"+game.i18n.localize("TRI.ui.proposeIntrusion")+"</h3></div>"
            if (event.shiftKey) {
                msg_content+="<div class=\"tinyd6 test-result\"><a class=\"gainResolve\" data-actor_id="+actor._id+" data-current_resolve="+actor.system.resources.resolve.value+"><h3 class=\"resolve-button\">"+game.i18n.localize("TRI.ui.resolveIntrusion")+"</h3></a></div>"
            ...
            {
                msg_content+="<div class=\"tinyd6 test-result\"><a class=\"gainKarma\" data-actor_id="+actor._id+" data-current_karma="+actor.system.resources.karma.value+"><h3 class=\"karma-button\">"+game.i18n.localize("TRI.ui.karmaIntrusion")+"</h3></a></div>"
        ...
        if (actor.type=="Player")
        {
            ...
            if (event.shiftKey) {
                ...
                if (karma < 0){karma=0}
                    ...
                    msg_content="<div class=\"tinyd6 test-result\"><h3 class=\"karma-button\">"+game.i18n.localize("TRI.ui.loseKarma2")+"</h3></div>"
                    chatData = {
                        content: msg_content,
                        speaker: ChatMessage.getSpeaker()
                    };
