export default class tinyChat {
    ...
    static _spendKarma (event, data){
      ...
      const archivo_template = '/systems/tinyd6/templates/chat/test-result-karma.html';
    ...
    static _gainResolve (event, data){
      ...
      const messageId = $(element)
            ...
            .attr('data-message-id');
      const message = game.messages.get(messageId)
      let msg_content="<div class=\"tinyd6 test-result\"><h3 class=\"disabled\">"+game.i18n.localize("TRI.ui.acceptIntrusion")+"</h3></div>"
